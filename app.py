...
from simplebot.config import SERVER, SSL_CONTEXT, HOST, PORT, DEVELOPMENT
...
element_tree.add_element("button", {"Ответы": "_questions"})
element_tree.add_element("branch", "_questions")
...
element_tree.add_element("url", {"СРМ RemoteHelpers": "https://crm.rh-s.com/"})
element_tree.add_element(
...
element_tree.add_element("url", {"Открой СРМ": "https://crm.rh-s.com/"})
element_tree.add_element(
    "button",
    {
        "Включить тайм-трекер": "_questions_enable_time_tracker",
