...
def keyboard(buttons_list: list, image=False):
    """generates keyboard JSON

    Args:
        buttons_list (list): list of ("button_name", "element_tree_tag") tuples
...
EMPLOYED_USER_MENU = keyboard([
    ("", "_questions_google"), # 0
    ("", "_questions_linkedin"), # 1
    ("", "_questions_CRM"),
    ("", "_questions_calendar"),# 3
    ("", "_questions_update"),
    ("", "_questions_time_tracker"), #5
    ("", "_questions_contacts"),
    ("", "_questions_bonus_n_salary"), # 7
    ("", "_questions_leads"),
    ("", "_questions_templates"), # 9
    ("", "_questions_connect"),
    ("", "_questions_followup"), # 11
    ("", "_questions_country"),
    ("", "_questions_status"), # 13
    ("", "_restart"),
    ("", "_feedback"), # 15
    ], 
    image=True)
